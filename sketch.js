...
function preload()
{
  ...
  ChangeAddress = loadImage("ChangeAddress.PNG");
...
function setup() 
{
  ...
  closeT2 = createSprite(10000000, 600, 100, 100);
...
function draw() 
{
  ...
  if(form3.email.value().includes('@') && form3.email.value().includes('.'))
  {
